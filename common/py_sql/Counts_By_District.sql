...
group by DISTRICT_GEOGRAPHY_NAME, TERM_NAME, subject, MEASUREMENT_SCALE_BID, TEST_NAME, DISTRICT_STANDARD_NAME,DISTRICT_AGENCY_CODE
order by MEASUREMENT_SCALE_BID, TEST_NAME, student_count desc;